...
def CostofItem():
    ...
    PriceofDrinks = (Item1 * 40) + (Item2 * 50) + (Item3 * 60) + (Item4 * 60) + (Item5 * 50) + (Item6 * 30) + (
                Item7 * 30) + (Item8 * 90)

    PriceofFood = (Item9 * 100) + (Item10 * 180) + (Item11 * 120) + (Item12 * 40) + (Item13 * 70) + (Item14 * 80) + (
                Item15 * 80) + (Item16 * 110)
...
#########################################Drinks####################################################################
Bananajuice = Checkbutton(Drinks_F, text='Bananajuice', variable=var1, onvalue=1, offvalue=0,
                          font=('arial', 18, 'bold'),
...
Promaganate = Checkbutton(Drinks_F, text='Promaganate', variable=var5, onvalue=1, offvalue=0,
                          font=('arial', 18, 'bold'),
